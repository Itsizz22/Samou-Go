  ...
  return (
    <div className="min-h-[60vh]">
      ...
      {!catalogue.loading && visibleProducts.length > 0 && (
        <div className="mobile-product-list overflow-hidden rounded-xl border border-line bg-surface shadow-card" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'thin' }}>
