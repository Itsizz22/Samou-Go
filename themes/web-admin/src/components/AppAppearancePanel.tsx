import { FeaturedStoresSettings } from './FeaturedStoresSettings';
  ...
  return <div className="mx-auto max-w-5xl space-y-6" dir="rtl">
    <section className="space-y-4 rounded-2xl border border-line bg-surface p-5">
      ...
      <nav aria-label="أدوات إدارة واجهة التطبيق" className="flex flex-wrap gap-2">
        <a href="#appearance-videos" className="inline-flex min-h-11 items-center rounded-xl bg-brand-tint px-4 text-sm font-bold text-brand-deep focus-visible:ring-2 focus-visible:ring-brand">إعلانات الفيديو</a>
    ...
    <div id="appearance-dishes" className="scroll-mt-24 space-y-5"><FeaturedStoresSettings /><CategoryImagesSettings /><FeaturedProductsSettings /></div>
    <div id="appearance-banners" className="scroll-mt-24"><BannerSettings /></div>
    <div id="appearance-videos" className="scroll-mt-24"><VideoAdSettings /></div>
  </div>;
}
