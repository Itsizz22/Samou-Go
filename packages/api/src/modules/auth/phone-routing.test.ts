...
describe('international OTP phone routing', () => {
  it.each(['+972599000008','00972599000008','972599000008'])('preserves account identity for %s without duplicating existing local identity', phone => {
    expect(otpRequestSchema.parse({phone})).toEqual({phone:'0599000008'});
  });
