...
authRouter.post('/otp/request', otpIpLimiter, asyncHandler(controller.requestOtpHandler));
authRouter.post('/otp/verify', otpIpLimiter, asyncHandler(controller.verifyOtpHandler));
...
authRouter.patch('/me/availability', authenticate, asyncHandler(controller.setAvailabilityHandler));
