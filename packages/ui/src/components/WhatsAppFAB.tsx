...
export function WhatsAppFAB({ href, label }: WhatsAppFABProps) {
  ...
  return (
    <a
      ...
      aria-label={label}
      title={label}
      className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] z-30 flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition hover:bg-green-600 hover:scale-110 active:scale-95 md:bottom-6"
